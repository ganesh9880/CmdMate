...
ExecStart={python_path} terminal.py --web
Restart=always
RestartSec=10
...
def create_heroku_deployment():
    ...
    # Procfile
    procfile_content = "web: python terminal.py --web --host 0.0.0.0 --port $PORT"
...
def create_railway_deployment():
  ...
  "deploy": {
    "startCommand": "python terminal.py --web --host 0.0.0.0 --port $PORT",
    "healthcheckPath": "/",
...
def start_local_server():
    ...
    try:
        subprocess.run([sys.executable, "terminal.py", "--web"])
