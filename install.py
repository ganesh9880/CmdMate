...
def main():
    ...
    print()
    print("Usage:")
    print("  CLI Terminal:    python terminal.py")
    print("  Web Interface:   python terminal.py --web")
    ...
    print()
    print("For help: python terminal.py --help")
    print("For web interface: python terminal.py --web")
